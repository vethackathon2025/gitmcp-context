...
- Generate printable rubrics (CSV) matching each exercise.
- Split these exercises into beginner/intermediate/advanced packs for cohort planning.
- Create lab-control scripts or small Vagrant/VM recipes for the suggested lab environments.
